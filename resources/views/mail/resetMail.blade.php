...
<div style="background-color: #fff9ec;text-align: center; margin-top: 45px;">
		<div>
			...
			<a href="http://192.168.10.111:8000/resetpassword?code={{$checkmail[0]['role']}}" style="background: #fbaa84;color: #000;box-shadow: 0 2px 4px 0 rgba(27,160,5,0.2);border-radius: 4px;border: 1px solid #ff9563;box-shadow: 0 2px 4px 0 rgba(0,0,0,0.12);
