...
<div style="background-color: #fff9ec;text-align: center; margin-top: 45px;">
		<div>
			...
			<span style="font-size:13.5pt;color:#fff;border:solid #fbaa84 6.0pt;" href="https://google.com">このメールアドレスで登録します</span>
			</a>
			</span>
			<br> 
			<div style="font-size:12px;color:#807c7c;">心当たりがない場合はこのメッセージを無視してください。</div>
			<br>
			<br>
