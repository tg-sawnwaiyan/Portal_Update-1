<div style="width:800px;margin-left:;margin-right:auto">
...
<div style="text-align: left; margin-top: 45px;">
        <div>
            ...
            <h5 style="color:#3e4348;font-size: 29px;margin-bottom: 30px;margin-top: 30px;font-weight: bold;text-align: left;">
            ...
            <a href="https://testikportal.management-partners.co.jp/login" style="background: #2980B9;color: #000;box-shadow: 0 2px 4px 0 rgba(27,160,5,0.2);border-radius: 4px;border: 1px solid #2980B9;box-shadow: 0 2px 4px 0 rgba(0,0,0,0.12);
            ...
            <span style="font-size:12pt;color:#fff;">ログイン</span>
            </a>
            </span>
            <br> <br/>
