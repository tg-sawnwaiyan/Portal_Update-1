        ...
        <div class="sitepolicy">
          <ol>
            ...
            <li>
              個人情報の取得、利用、提供
              <br />
              <span>当社は、介護施設斡旋事業、広告事業、情報サイト運営事業などを行う事業者として、個人情報の利用目的を明確に定め、その目的達成のために必要な範囲で、公正かつ適正な手段により適切な個人情報の取得、利用を行います。</span>
              <br />
            </li>
            <li>
              個人情報の管理
        ...
        <div class="sitepolicy">
          <ol>
            <li>
              個人情報の利用目的
              <br />
              <span>株式会社TRUST-ESTATE（以下「当社」と言います）は、お客様個人を識別する基本情報として、お客様のお名前・ご住所・お電話番号・ 生年月日・メールアドレスなどの個人情報 および 当社とのお取引状況などの情報を以下の目的で利用いたします。</span>
              <ol class="sub-ol">
