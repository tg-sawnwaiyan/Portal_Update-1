  ...
  <div class="card profile m-t-22 " style="border:none;">
    <form class="col-md-12 form-class">
     <div class="col-md-12 pad-free">
        ...
        <div class=" hos-all form-group form-group-wrapper d-flex">

                <label class=" heading-lbl col-2  pad-free ">メールアドレス<span class="error">*</span></label>
                <label class="email-label-responsive col-10 float-right customer-email p-0 ml-auto"> {{customer_info.email}} </label>
        ...
        <div class="form-group form-group-wrapper">
          ...
          <label class="toggle-responsive col-2 pad-free">フォトアルバム</label>
        ...
        <div class="form-group form-group-wrapper">
          ...
          <label class="toggle-responsive col-2 pad-free">動画</label>
        ...
        <table class="table table-bordered table-wrapper">
            <tr>
                <td>
                    <div class="form-group">
                        <label  class="toggle-responsive col-2 pad-free">診療科目</label>
        ...
        <div class="form-group form-group-wrapper row ml-0 mr-0">
          ...
          <label class="toggle-responsive col-2 pad-free">
        ...
        <table class="table table-bordered table-wrapper">
          <tr>
                  <td class="width17 hos-table-responsive" style="border:none;"> <label class="heading-responsive pad-free"> 医院からのお知らせ<span class="error">*</span></label></td>


                  <td style="border:none;" class="hos-table-responsive">
        ...
        <table class="table table-bordered table-wrapper">
          ...
          <tr>
            ...
            <td>
              ...
              <label class="toggle-responsive col-2 pad-free">診療時間</label>
        ...
        <div class="form-group form-group-wrapper row ml-0 mr-0">
          ...
          <label class="heading-responsive col-2 pad-free">休診日</label>
          ...
          <tr>
            ...
            <td>
              ...
              <div class="form-group">
                ...
                <label class="toggle-responsive col-2 pad-free">施設情報</label>
        ...
        <div class="form-group form-group-wrapper row ml-0 mr-0">
          ...
          <label class="toggle-responsive col-2 pad-free">公式サイト</label>
        ...
        <div class="form-group form-group-wrapper row mr-0 ml-0">
          ...
          <label class="toggle-responsive col-2 pad-free">混雑状況</label>
