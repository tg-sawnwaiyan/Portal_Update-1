...
module.exports = function () {
    ...
    function _loginAdminPerform(data) {
        return __duckPunch.call(this, 'loginAdmin', data);
    }
    function _loginAdminProcess(res, data) {
        var _this = this;
    ...
    function _logoutAdminPerform(data) {
        data = __utils.extend(this.options.logoutAdminData, [data || {}]);

        if (data.makeRequest) {
            return __duckPunch.call(this, 'logoutAdmin', data);
        }
        else {
            this.options.logoutAdminProcess.call(this, null, data);
        }
    }
    ...
    function _logoutAdminProcess(res, data) {
        __cookie.remove.call(this, 'rememberMe');
    ...
    var defaultOptions = {
        ...
        loginAdminData:     {url: 'auth/admin_login',   method: 'POST', redirect: '/', fetchUser: true},
        logoutData:         {url: 'auth/logout',        method: 'POST', redirect: '/login', makeRequest: false},
        logoutAdminData:         {url: 'auth/admin_logout',        method: 'POST', redirect: '/admin_login', makeRequest: false},
        ...
        loginAdminPerform: _loginAdminPerform,
        loginAdminProcess: _loginAdminProcess,

        logoutPerform:      _logoutPerform,
        logoutProcess:      _logoutProcess,

        logoutAdminPerform:      _logoutAdminPerform,
        logoutAdminProcess:      _logoutAdminProcess,
    ...
    Auth.prototype.loginAdmin = function (data) {
        return __bindContext.call(this, 'loginAdmin', data);
    };
    ...
    Auth.prototype.logoutAdmin = function (data) {
        return __bindContext.call(this, 'logoutAdmin', data);
    };
